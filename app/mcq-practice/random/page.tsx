...
export default function RandomMcqPracticePage() {
  ...
  useEffect(() => {
    async function fetchRandomMcqs() {
      try {
        // Fetch all MCQ sets
        ...
        // Shuffle and take 10 random MCQs
        const shuffled = allMcqs.sort(() => 0.5 - Math.random())
        const randomMcqs = shuffled.slice(0, 10)

        setMcqs(randomMcqs)
      } catch (error) {
        console.log("Error loading random MCQs:", error)
      } finally {
        setLoading(false)
      }
    }
    ...
    return (
      <div className="container py-8 flex justify-center items-center min-h-[50vh]">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">Loading random MCQs...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="flex flex-col gap-6 max-w-2xl mx-auto">
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-muted-foreground mb-6">There are no MCQs available for random practice yet.</p>
              <Button asChild>
  ...
  if (completed) {
    ...
    return (
      <div className="container py-8 max-w-2xl mx-auto">
        <Card>
          <CardHeader>
            <CardTitle className="text-xl text-center">Random Practice Complete</CardTitle>
          </CardHeader>
